...
function pledgeSuccess (event) {
    ...
    let message = "Your pledge brings us one step closer to    sharing Mastercraft Bamboo Monitor Riser worldwide. You will get an email once our campaign is completed."
    closeModal();
